                                ...
                                <ul class="sidebar-menu">
                                    <li class="sidebar-menu-item active open">
                                        ...
                                        <ul class="sidebar-submenu collapse show "
                                            ...
                                            <li class="sidebar-menu-item mt-">
                                                <a class="sidebar-menu-button"
                                                   href="/commonApplication"> 
                                                    <span class="sidebar-menu-text ">Common Application</span>
                                                </a>
                                            </li>
                                            <li class="sidebar-menu-item mt-">
                                                <a class="sidebar-menu-button"
                                                   href="/collageApplication">
                                                    <span class="sidebar-menu-text">Collage Application</span>
                                                </a>
                                            </li>
                                            ...
                                            <li class="sidebar-menu-item">
                                                <a class="sidebar-menu-button"
                                                   href="/contactSupport">
                                                    <span class="sidebar-menu-text">Contact Support</span>
                                                </a>
                                            </li>
                                            <li class="sidebar-menu-item">
                                                <a class="sidebar-menu-button"
                                    ...
                                    <a href="route('admin')"
                                       class="flex d-flex align-items-center text-underline-0 text-body">
                                        ...
                                        <span class="flex d-flex flex-column">
                                            ...
                                            <small class="text-muted text-uppercase">Site Student</small>
                                        </span>
                                    </a>
