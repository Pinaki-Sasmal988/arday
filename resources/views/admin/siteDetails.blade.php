                    ...
                    @endif    
                                ...
                                <div class="row no-gutters">
                                    ...
                                    <div class="col-lg-8 card-form__body card-body">
                                        ...
                                        <div class="form-group">
                                            <label for="social1">Social links <span class="text-danger">[DON'T ADD HTTP/HTTPS IN FRONT OF LINKS]</span></label>
                                            ...
                                            <div class="input-group input-group-merge mb-2"
                                                ...
                                                <input id="social4"
                                                       type="text"
                                                       class="form-control form-control-prepended"
                                                       placeholder="Youtube" name="youtube_link" value="{{$current_details->youtube}}">
                                                <div class="input-group-prepend">
                                                    <div class="input-group-text">
                                            ...
                                            <div class="input-group input-group-merge mb-2"
                                                ...
                                                <input id="social5"
                                                       type="text"
                                                       class="form-control form-control-prepended"
                                                       placeholder="Whatsapp[Enter 10 digits number only]" name="whatsapp_link" value="{{$current_details->whatsapp}}">
                                                <div class="input-group-prepend">
                                                    <div class="input-group-text">
                                            ...
                                            <div class="input-group input-group-merge mb-2"
                                                ...
                                                <input id="social6"
                                                       type="text"
                                                       class="form-control form-control-prepended"
                                                       placeholder="Play Store Link" name="playStore_link" value="{{$current_details->playstore}}">
                                                <div class="input-group-prepend">
                                                    <div class="input-group-text">
                                            ...
                                            <div class="input-group input-group-merge mb-2"
                                                ...
                                                <input id="social7"
                                                       type="text"
                                                       class="form-control form-control-prepended"
                                                       placeholder="App Store Link" name="appStore_link" value="{{$current_details->appstore}}">
                                                <div class="input-group-prepend">
                                                    <div class="input-group-text">
