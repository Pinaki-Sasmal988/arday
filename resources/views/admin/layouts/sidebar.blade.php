                                ...
                                <ul class="sidebar-menu">
                                    <li class="sidebar-menu-item active open">
                                        ...
                                        <ul class="sidebar-submenu collapse show "
                                            ...
                                            <li class="sidebar-menu-item">
                                                <a class="sidebar-menu-button"
                                                   href="{{route('allColleges')}}">
                                                    <span class="sidebar-menu-text">View Colleges</span>
                                                </a>
                                            </li>
                                            <li class="sidebar-menu-item">
                                                <a class="sidebar-menu-button"
                                                   href="{{route('addCollege')}}">
                                                    <span class="sidebar-menu-text">Add College</span>
                                                </a>
                                            </li>
                                            <li class="sidebar-menu-item">
                                                <a class="sidebar-menu-button"
                                                   href="{{route('addAdmin')}}">
                                                    <span class="sidebar-menu-text">Add Admin</span>
                                                </a>
                                            </li>
                                            <li class="sidebar-menu-item">
                                                <a class="sidebar-menu-button"
                                            ...
                                            <li class="sidebar-menu-item">
                                                <a class="sidebar-menu-button"
                                                   href="{{route('slider')}}">
                                                    <span class="sidebar-menu-text">Slider Images</span>
                                                </a>
                                            </li>
                                            <li class="sidebar-menu-item">
                                                <a class="sidebar-menu-button"
                                            ...
                                            <li class="sidebar-menu-item">
                                                <a class="sidebar-menu-button"
                                                   href="{{route('allUserApp')}}">
                                                    <span class="sidebar-menu-text">User Applications</span>
                                                </a>
                                            </li>
                                            <li class="sidebar-menu-item">
                                                <a class="sidebar-menu-button"
                                                   href="{{route('allGuestApp')}}">
                                                    <span class="sidebar-menu-text">Guest Applications</span>
                                                </a>
                                            </li>
                                            <li class="sidebar-menu-item">
                                                <a class="sidebar-menu-button"
                                                   href="{{route('allCAP')}}">
                                                    <span class="sidebar-menu-text">Common App. Process</span>
                                                </a>
                                            </li>
                                            <li class="sidebar-menu-item">
                                                <a class="sidebar-menu-button"
                                                   href="{{route('admin-siteDetails')}}">
                                                    <span class="sidebar-menu-text">View/Edit Details</span>
                                                </a>
                                            </li>
                                            <li class="sidebar-menu-item">
                                                <a class="sidebar-menu-button"
                                                   href="{{route('showMarquee')}}">
                                                    <span class="sidebar-menu-text">Information Banner[Marquee]</span>
                                                </a>
                                            </li>
                                        </ul>
                                    </li>
                                    ...
                                    <a href="route('admin')"
                                       class="flex d-flex align-items-center text-underline-0 text-body">
                                        ...
                                        <span class="flex d-flex flex-column">
                                            ...
                                            <small class="text-muted text-uppercase">Site Admin</small>
                                        </span>
                                    </a>
