...
<body width="100%" bgcolor="#F1F1F1" style="margin: 0; mso-line-height-rule: exactly;">
    <center style="width: 100%; background: #F1F1F1; text-align: left;">
        <div style="display:none;font-size:1px;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;mso-hide:all;font-family: sans-serif;">{{$data['name']}}, Thanks for Applying. </div>
        <div style="max-width: 680px; margin: auto;" class="email-container">
            <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" width="100%" style="max-width: 680px;" class="email-container">
                <tr>
                    <td style="background: linear-gradient(to right, #480048, #C04848);">
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td style="padding: 30px 40px 30px 40px; text-align: center;"> <span style="color:#fff; font-size: 30px"><img src="{{asset('assets/img/logo.png')}}" style="vertical-align:middle;padding-right: 10px;" height="60">Career Cognitive</span> </td>
                            </tr>
                        </table>
                    </td>
                </tr> 
                ...
                <tr>
                    <td bgcolor="#ffffff">
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td valign="top" style="text-align: center; padding: 60px 0 10px 20px;">
                                    <h3 style="margin: 0; font-family: 'Montserrat', sans-serif; font-size: 24px; line-height: 36px; color: #000000; font-weight: bold;"></h3>
                                </td>
                            </tr>
                           <tr>
                            ...
                            <!--<tr>
                                <td style="padding: 0px 40px 20px 40px; font-family: sans-serif; font-size: 18px; line-height: 20px; color: #555555; text-align: left; font-weight:normal;">
                                    <p style="margin: 0;">Thanks for Applying for Common Application.<br>Below is the information of your application.</p>
                                </td>
                            </tr>-->
                            <tr>
                                <td style="padding: 0px 40px 20px 40px; font-family: sans-serif; font-size: 16px; line-height: 20px; color: #555555; text-align: left; font-weight:normal;">
                                    <h3 style="margin: 0;">Thank you for visiting our website and taking admission in {{$data['course']}} at {{$data['college']}}.</h3> 
<h3>Your application has been received and hence we need a few more details to proceed further. </h3><h3>Please share the below mentioned documents & details through email and WhatsApp on: 9563769563  and make the payment of INR 15000/-, your admission fees through the link given which will be adjusted in Fee Package of your GNM Course.
 </h3>
                            ...
                            <tr>
                                <td style="padding: 0px 40px 20px 40px; font-family: sans-serif; font-size: 16px; line-height: 20px; color: #555555; text-align: left; font-weight:normal;">
                                    <h3 style="margin: 0;">Documents & details required –</h3>
                                    <h3>So that we can assist you further.</h3>
                                    <h3>
                                        • 10th Marksheet<br> 
                                        • 10th Admit Card<br> 
                                        • Photo<br> 
                            ...
                            <tr>
                                <td style="padding: 0px 40px 20px 40px; font-family: sans-serif; font-size: 16px; line-height: 20px; color: #555555; text-align: left; font-weight:normal;">
                                    <h4>
                                        For any further concerns please write us to admissions@shushrutigroupofinstitutions.com <br> or <br> Contact us at 9563769563.
                                    </h4>
                                </td>
                            </tr>
                            <tr>
                        ...
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td style="padding: 20px 20px 15px 20px; text-align: center;">
                                    <h1 style="margin: 0; font-family: 'Montserrat', sans-serif; font-size: 17px; line-height: 24px; color: #ffffff; font-weight: bold;">Online Admission Seat Booking fee payment</h1>
                                </td>
                            </tr>
                            <!--<tr>
                ...
                <tr>
                    <td bgcolor="#ffffff">
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"> <br>
                            <tr>
                                <td align="center"> <img src="{{asset('assets/img/logo-dark.png')}}" width="47" height="47" style="display: block; border: 0px;" /> </td>
                            </tr>
                            <tr>
                                <td align="center" style="font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 14px; font-weight: 400; line-height: 24px; padding: 5px 0 10px 0;">
                                    <p style="font-size: 14px; font-weight: 800; line-height: 18px; color: #333333;"> Career Cognitive<br>Banaswadi, Bangalore, Karnataka. </p>
                                </td>
                            </tr>
                            <!--<tr>
                            ...
                            <tr>
                                <td style="padding: 0px 40px 40px 40px; font-family: sans-serif; font-size: 12px; line-height: 18px; color: #666666; text-align: center; font-weight:normal;">
                                    <p style="margin: 0;">Copyright &copy;  <b>Career Cognitive</b>, All Rights Reserved.</p>
                                </td>
                            </tr>
                        </table>
                    </td>
