...
<body width="100%" bgcolor="#F1F1F1" style="margin: 0; mso-line-height-rule: exactly;">
    <center style="width: 100%; background: #F1F1F1; text-align: left;">
        <div style="display:none;font-size:1px;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;mso-hide:all;font-family: sans-serif;"> Dear {{$name}} Thanks For Registering. </div>
                ...
                <tr>
                    <td bgcolor="#ffffff">
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td valign="top" style="text-align: center; padding: 60px 0 10px 20px;">
                                    <h1 style="margin: 0; font-family: 'Montserrat', sans-serif; font-size: 30px; line-height: 36px; color: #000000; font-weight: bold;">Welcome {{$name}},</h1>
                                </td>
                            </tr>
                           <!--<tr>
                            ...
                            <tr>
                                <td style="padding: 0px 40px 20px 40px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555; text-align: left; font-weight:normal;">
                                    <p style="margin: 0;">I’m Sagar Manna, the founder of Career Cognitive and I’d like to personally Thank You for signing up to our service.</p><p>We established Career Cognitive in order to serve you the best services in Education Industry.</p><p>I’d love to hear if there is anything we can also suggest. If you have any questions, please reply to this email.</p><br>
                                    
                                   <p><strong>Your User Id Is:-{{ $email }}.<strong></p>
                                   <p><strong>Your Password Is:-{{ $email}}.<strong></p>

                                    <p><strong>I’m always happy to help!</strong></p>
                                    <p>
                                        Thanks & Regards,<br>
                                        Team Arday<br>
                                        Arday.com<br>
                                        Banaadir , Country: Somalia,Zip Code: 00252.
                        ...
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td style="padding: 20px 20px 15px 20px; text-align: center;">
                                    <h1 style="margin: 0; font-family: 'Montserrat', sans-serif; font-size: 20px; line-height: 24px; color: #ffffff; font-weight: bold;">YOUR ACCOUNT IS ACTIVE</h1>
                                </td>
                            </tr>
                            <!--<tr>
