...
<body width="100%" bgcolor="#F1F1F1" style="margin: 0; mso-line-height-rule: exactly;">
    <center style="width: 100%; background: #F1F1F1; text-align: left;">
        <div style="display:none;font-size:1px;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;mso-hide:all;font-family: sans-serif;"> Common Application Form Submitted Successfully. </div>
                           ...
                           <tr>
                            ...
                            <tr>
                                <td style="padding: 0px 40px 20px 40px; font-family: sans-serif; font-size: 16px; line-height: 20px; color: #555555; text-align: left; font-weight:normal;">
                                    <h3 style="margin: 0;">Thanks for applying For {{$data['course']}} Course at our colleges in {{$data['state']}}.</h3><h3>Our Education Counsellors will call you for further assistance.</h3>
                                    
                                </td>
                            </tr>
                            <tr>
                                <td style="padding: 0px 40px 20px 40px; font-family: sans-serif; font-size: 16px; line-height: 20px; color: #555555; text-align: left; font-weight:normal;">
                                    <h3 style="margin: 0;">Till than we request you to please be ready with minimum selection of at least 5 colleges.</h3><h3>So that we can assist you further.</h3>
                                    <p>
                                        Thanks & Regards,<br>
                                        Team SAGAR Manna<br>
                        ...
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td style="padding: 20px 20px 15px 20px; text-align: center;">
                                    <h1 style="margin: 0; font-family: 'Montserrat', sans-serif; font-size: 20px; line-height: 24px; color: #ffffff; font-weight: bold;">VIEW YOUR ACCOUNT</h1>
                                </td>
                            </tr>
                            <!--<tr>
                ...
                <tr>
                    <td bgcolor="#ffffff">
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"> <br>
                            <tr>
                                <td align="center"> <img src="{{asset('assets/img/logo-dark.png')}}" width="37" height="37" style="display: block; border: 0px;" /> </td>
                            </tr>
                            <tr>
